            ...
            <RadioGroup value={color} marginTop={2}>
              <HStack justify="center">
                <Radio value="red" onChange={handleColorChange}>
                  <Badge
                    colorScheme="red"
                    variant={color === "red" ? "solid" : "outline"}
                  >
                    Red
                  </Badge>
                </Radio>
                <Radio value="green" onChange={handleColorChange}>
                  <Badge
                    colorScheme="green"
                    variant={color === "green" ? "solid" : "outline"}
                  >
                    Green
                  </Badge>
                </Radio>
                <Radio value="blue" onChange={handleColorChange}>
                  <Badge
                    colorScheme="blue"
                    variant={color === "blue" ? "solid" : "outline"}
                  >
                    Blue
                  </Badge>
                </Radio>
                <Radio value="orange" onChange={handleColorChange}>
                  <Badge
                    colorScheme="orange"
                    variant={color === "orange" ? "solid" : "outline"}
                  >
                    Orange
                  </Badge>
                </Radio>
                <Radio value="yellow" onChange={handleColorChange}>
                  <Badge
                    colorScheme="yellow"
                    variant={color === "yellow" ? "solid" : "outline"}
                  >
                    Yellow
                  </Badge>
                </Radio>
                <Radio value="gray" onChange={handleColorChange}>
                  <Badge
                    colorScheme="gray"
                    variant={color === "gray" ? "solid" : "outline"}
                  >
                    Gray
                  </Badge>
                </Radio>
                <Radio value="teal" onChange={handleColorChange}>
                  <Badge
                    colorScheme="teal"
                    variant={color === "teal" ? "solid" : "outline"}
                  >
                    Teal
                  </Badge>
                </Radio>
                <Radio value="cyan" onChange={handleColorChange}>
                  <Badge
                    colorScheme="cyan"
                    variant={color === "cyan" ? "solid" : "outline"}
                  >
                    Cyan
                  </Badge>
                </Radio>
                <Radio value="purple" onChange={handleColorChange}>
                  <Badge
                    colorScheme="purple"
                    variant={color === "purple" ? "solid" : "outline"}
                  >
                    Purple
                  </Badge>
                </Radio>
                <Radio value="pink" onChange={handleColorChange}>
                  <Badge
                    colorScheme="pink"
                    variant={color === "pink" ? "solid" : "outline"}
                  >
                    Pink
                  </Badge>
                </Radio>
